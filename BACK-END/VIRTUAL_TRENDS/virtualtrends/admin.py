...
admin.site.register(Productos, list_display=( 'id_prod', 'nombre', 'desc', 'stock', 'precio', 'talle_personalizado', 'eliminar', 'id_cat'), list_filter=['nombre', 'desc', 'stock', 'precio', 'talle_personalizado', 'eliminar', 'id_cat'], search_fields=['nombre', 'desc', 'stock', 'precio', 'talle_personalizado', 'eliminar', 'id_cat'])
